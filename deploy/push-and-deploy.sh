...
#
#   deploy/deploy-hold.sh   (Hold only)
#
# Staging/production MyEventLane are deployed from a SEPARATE repository,
# github.com/anna-pye/mel-deployment — never from Mel_hold.
#
...
sibling site. Use the per-application script instead:
  ...
  cd /home/mel/sites/myeventlane_hold && ./deploy/deploy-hold.sh [--dry-run] [--yes]

Staging is deployed from github.com/anna-pye/mel-deployment, not here.
