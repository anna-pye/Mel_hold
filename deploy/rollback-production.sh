#!/usr/bin/env bash
#
# rollback-production.sh — roll MEL Production back to a previous backup.
# Hardcoded target. Run ON THE SERVER:
#
#   bash /home/mel/sites/myeventlane_production/deploy/rollback-production.sh [BACKUP_DIR|--list]
#
set -euo pipefail
